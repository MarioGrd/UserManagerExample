...
@Component
@Scope("prototype")
class PreRequestLogging(@Autowired private val logger: Logger) : PreRequestHandler<Request<Any>, Any> {
...
@Component
@Scope("prototype")
class PostRequestLogging (@Autowired private val logger: Logger) : PostRequestHandler<Request<Any>, Any> {
    override fun handle(request: Request<Any>) {
